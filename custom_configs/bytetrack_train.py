_base_ = ['../configs/yolox/yolox_x_8xb8-300e_coco.py']

dataset_type = 'MOTChallengeDataset'
data_root = '/code/data/datasets/SAT-MTB_ship/' # 使用的数据集
...
# optimizer
# default 8 gpu
base_lr = 0.001 / gpu_count * batch_size
...
val_evaluator = dict(
    ...
    outfile_prefix='/data/code/outputs/bytetrack_plane/metric_results/',
...
auto_scale_lr = dict(base_batch_size=gpu_count*batch_size)
